...
@Service
public class EducacionServiceImple extends BaseServiceImple<EducacionModel, Long> implements EducacionService {
    public EducacionServiceImple(BaseRepository<EducacionModel, Long> baseRepository) {
